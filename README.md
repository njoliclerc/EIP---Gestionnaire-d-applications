...
- **Effectuer les livraisons** en environnement de [**recette**](https://perso.liris.cnrs.fr/amelie.cordier/teaching/recettes/), puis en **production** (MEP – mise en production) (Cf. [C'est quoi un environnement de production ?](###cest-quoi-un-environnement-de-production).
